...
{
    //manages major interface elements and panels

    private const int
        noAnchors = 4, //includes 3 fading "Plus buttons" + the day/night "clock"
        noResPB = 6; //all resources + builder/cloak
    ...
    public bool constructionGreenlit = true, waitForPlacement;
    ...
    private void
        Delay() //brief delay to prevent selecting the buildint underneath menus if button positions overlap - the "double command" 
    {
