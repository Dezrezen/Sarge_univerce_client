...
namespace EasyUI.Tabs {
   ...
   public abstract class TabsUI : MonoBehaviour {
      ...
      [SerializeField]
      private RectTransform parentWithContentForTabs;
      ...
      private void GetTabBtns () {
         ...
         tabContentNum = parentWithContentForTabs.childCount ;
         ...
         for (int i = 0; i < tabBtnsNum; i++) {
            ...
            tabBtns[i].SetTabIndex(i);
            
            tabContent [ i ] = parentWithContentForTabs.GetChild (i).gameObject ;
      ...
      private void OnTabChangeHandler(int index)
      {
         if (OnTabChange != null)
      ...
      public void UpdateThemeColor (Color color) {
         ...
         parentWithContentForTabs.GetComponent <Image> ().color = color ;
      }
